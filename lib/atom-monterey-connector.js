...
export default {
  ...
  signal() {
    ...
    signalData['monterey'] = {width: 200, height: 0, project: atom.project.getPaths()[0]}
  ...
  resize: function(signalData) {
    ...
    console.log("The project paths are ") // Test
    console.log(util.inspect(projectPaths)) // Test

    if (projectPaths.indexOf(signalData.monterey.project) != -1) {
      ...
      console.log("Atom has been resized.") // Test
    }
    else {
